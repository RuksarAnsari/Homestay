...
<body>
	<h1>
		<marquee>Registration Form Of Stay Owner</marquee>
	</h1>
	<div class="reg">

		<form name="adminform" onsubmit="return validate()" id="reg"
			method="post" action="Admin_registrationServlet">
			...
			<label>Home stay name:<span style="color:red">*</span></label><br> 
				<input type="text"name="stayname" placeholder="homestay" id="stayname" required><br><br>
				 ...
				 <input type="text"name="adminname" placeholder="Username" id="adminname" required><br><br> 
				 <label>password:<span style="color:red">*</span></label><br> 
				 <input type="password"name="password" placeholder="password" id="password" ><span
				id="pwd"></span> <br> <br> 
				<label>Confirmpassword:<span style="color:red">*</span></label><br> 
				<input type="password" name="conpassword"placeholder="Confirm password" id="conpassword" required><span
				id="conpwd"></span> <br> <br> 
		...
		<label>State:<span style="color:red">*</span></label><br> <select name="state">
			...
			<script>
				function validate() {
					...
					if (c.length > 20) {
						document.getElementById("pwd").innerHTML = "**password must less than 20 digits";
						return false;
					}
